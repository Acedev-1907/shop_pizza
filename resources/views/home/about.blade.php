...
@section('main')
    ...
    <main>
        ...
        <!-- team-area -->
        <section class="team-area team-bg" data-background="upload/bg/team_bg.jpg">
                        ...
                        <div class="team-item-wrap">
                            <div class="row justify-content-center">
                                <div class="col-lg-4 col-md-6 col-sm-8">
                                    <div class="team-item">
                                        <div class="team-thumb">
                                            <img src="upload/team/team_img01.jpg" alt="">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-8">
                                    <div class="team-item">
                                        <div class="team-thumb">
                                            <img src="upload/team/team_img02.jpg" alt="">
                                            <a href="team-details.html" class="link-btn"><i class="fas fa-plus"></i></a>
                                        </div>
                                        <div class="team-content">
                                            <div class="line" data-background="upload/images/line.png"></div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-8">
                                    <div class="team-item">
                                        <div class="team-thumb">
                                            <img src="upload/team/team_img03.jpg" alt="">
                                            <a href="team-details.html" class="link-btn"><i class="fas fa-plus"></i></a>
                                        </div>
                                        <div class="team-content">
                                            <div class="line" data-background="upload/images/line.png"></div>
